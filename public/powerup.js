...
/* ─────────────────────────────────────────
   generateCoverHTML — clean minimal card cover:
   [Tag pill]           [timer]
   Card Name (bold)
   [thin progress bar, full width, flush bottom]
───────────────────────────────────────── */
...
<style>
  *{margin:0;padding:0;box-sizing:border-box;}
  ...
  .timer{font-family:"SF Mono","Fira Code",monospace;font-size:13px;font-weight:700;
    color:#00b8d9;letter-spacing:0.06em;white-space:nowrap;}
  .card-name{
